...
import { createProject, getProjects, updateProject, updatePlanStatus, getProjectMessages, sendProjectMessage, completeProject, markMessagesRead, deleteProject } from '../controllers/projectController.js';
...
router.delete('/:id', verifyToken, checkRole(['Администратор']), deleteProject);
