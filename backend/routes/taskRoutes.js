...
import { createTask, getMyTasks, updateTask, approveStage, createStage, deleteStage, deleteTask, rejectStage, renameStage, editTask, deleteAttachment, rejectTask, requestTransfer, acceptTransfer, rejectTransfer, cancelTransfer, adminReassignTask, requestStageApproval, cancelStageApproval } from '../controllers/taskController.js';
...
router.put('/stage/:stageId/request-approval', verifyToken, checkRole(['Прораб']), requestStageApproval);
router.put('/stage/:stageId/cancel-approval', verifyToken, checkRole(['Прораб']), cancelStageApproval);
